...
const { User, Post, Event, Job, Mentorship, Donation } = require('../models');
...
// Get donations
router.get('/donations', protect, requireRole('admin'), async (req, res) => {
try {
const donations = await Donation.find()
.populate('donor', 'name email profilePic')
.sort({ createdAt: -1 });
